...
function Results() {
       ...
       //getting data of currentUser
        async function getUsers() { 
                ...
                try{
                    ...
                    console.log("No data to be fechted")
                }
  ...
  return <div className='result'>
           {addMemberClicked && <Addmember/>}
            ...
            <Table data={users} filtercompany={selectedCompany} status={dropdown}></Table>
        </div>;
}
